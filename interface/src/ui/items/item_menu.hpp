...
namespace Interface
{
	namespace Items
	{
		...
		public:
			...
			static void configurar(const std::string &font_path = "assets/fontes/consolas/consolas.tff", uint resolucao = 12);
			virtual void defMoldura(Formas::Moldura*);
			void definirEscondido(bool boleano);
			void quebrarLinha(bool boleano);
			int largura{ 0 }, altura{ 0 };
		protected:
			Vector2 box_pos{ 0, 0 }, line_pos{ 0, 0 };

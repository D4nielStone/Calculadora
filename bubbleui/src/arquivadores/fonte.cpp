...
std::map<char32_t, Character>* Bubble::Arquivadores::obterCaracteres()
{   
    return &Characters;
}

void Bubble::Arquivadores::carregarFonte(std::string path)
{
    if (!ft_carregado)
    {
        glEnable(GL_BLEND);
...
void Bubble::Arquivadores::definirResolucao(int resolution)
{

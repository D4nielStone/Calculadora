...
Interface::Widgets::Arvore::Arvore(const std::string &l, bool* retorno) : retorno(retorno)
{
    frase = l;
}
...
// Construtor da classe Arvore, inicializa os membros da classe.
Interface::Widgets::Arvore::Arvore(std::shared_ptr<std::string>l, bool* retorno) : retorno(retorno)
{
    label_shared = l;
...
void Interface::Widgets::Arvore::atualizar()
{
...
void Interface::Widgets::Arvore::renderizar() const
{
...
void Interface::Widgets::Arvore::defPainel(Painel* painel)
{
...
void Interface::Widgets::Arvore::adiFilho(std::shared_ptr<Widget> filho)
{

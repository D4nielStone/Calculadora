...
namespace Interface
{
	namespace Widgets
	{
		...
		protected:
			...
			bool desenharSelecao(Vector2<bool> mouse_inicial, Vector2<bool> mouse_final, Vector4<float> char_rect, size_t letra_idx);
			...
			Vector2<int> box_size, box_pos, line_pos;
			const Vector2<uint> letra_padding{3, 3};
			std::string frase;
			Color cor, cor_de_selecao{ 0.678f, 0.847f, 0.902f, 1.0f};
			Vector2<int> pos_texto;

...
uint Bubble::Arquivadores::TextureFromFile(const std::string& directory, int* width_ptr , int* height_ptr) {
...
uint Bubble::Arquivadores::TextureFromFile(unsigned char* data, uint width, uint height, int nrComponents) {

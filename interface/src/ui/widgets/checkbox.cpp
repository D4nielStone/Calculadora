...
Interface::Widgets::CheckBox::CheckBox(bool* retorno, const std::string& texto, const Alinhamento& alinhamento) 
    : retorno(retorno)
{
...
void Interface::Widgets::CheckBox::atualizar()
{
...
void Interface::Widgets::CheckBox::renderizar() const
{
    moldura.renderizar();
    if (!frase.empty())
        Texto::renderizar();
...
void Interface::Widgets::CheckBox::renderizarImg() const
{
    shaderImg.use();
    shaderImg.setVec2("quadrado.posicao", moldura.obtRectNDC().x, moldura.obtRectNDC().y);
    shaderImg.setVec2("quadrado.tamanho", moldura.obtRectNDC().w, moldura.obtRectNDC().h);

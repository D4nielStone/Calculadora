...
extern "C" BEUI_DLL_API void callbackKey(GLFWwindow* window, int key, int scancode, int action, int mods);
extern "C" BEUI_DLL_API void mouseButtonCallBack(GLFWwindow* window, int a, int b, int c);
extern "C" BEUI_DLL_API void charCallback(GLFWwindow* window, unsigned int codepoint);
...
static std::string to_short_string(double value)
{
...
Interface::Widgets::CaixaTexto::CaixaTexto(const std::string &mensagem)
...
Interface::Widgets::CaixaTexto::CaixaTexto(std::shared_ptr<std::string> buffer, const std::string& mensagem)
...
Interface::Widgets::CaixaTexto::CaixaTexto(std::string* buffer, const std::string& mensagem, const bool &apenas_numeros)
...
void Interface::Widgets::CaixaTexto::atualizar()
{
    ...
    if (painel->selecionado) 
    {
        ...
        if (selecionando_texto) area_de_selecao = { static_cast<int>(mouse_pos_ini.x), static_cast<int>(mouse_pos_ini.y), (int)inputs->mousex, (int)inputs->mousey };
    }
...
void Interface::Widgets::CaixaTexto::renderizar() const
{
    moldura.renderizar();
    Texto::renderizar();
    // Renderiza o cursor
...
void Interface::Widgets::CaixaTexto::defPainel(Painel* painel)
{
    Interface::Widgets::Texto::defPainel(painel);
...
void Interface::Widgets::CaixaTexto::processarEntrada(char c)
{
...
void Interface::Widgets::CaixaTexto::atualizarInputs()
{
...
void Interface::Widgets::CaixaTexto::iniciarSelecao()
{
